...
st.title("StatiX")
st.write("App per la visualizzazione dei dati statistici relativi al Comune di Lecco (minori, adulti e over 65 anni, scuole e asil) - statistiche a cura dell'ufficio SIT - aggiornate il 31/01/2024")
